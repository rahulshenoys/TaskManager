...
public class startApp 
{
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			String categoryName,taskName,taskDescription,taskTags,date="null";
			...
			while(choice1!=6)
			{
				...
				case 1:
					...
					System.out.println("Enter category name \n [Name should be one word,Starts woth letter without any special character]");
					...
					if(Model.isTheCategoryExist(categoryName))
					{
						...
						System.out.println("Category already exits...Please try again another name");
						System.out.println("Check list category once to know are the categories already exists");
					}
					else
					{
						...
						while(choice2!=6)
						{
							...
							case 1:
								...
								outer:while(b)
								{
									if(!Model.checkIfTaskExists(category,taskName))
									{
										...
										{
											System.out.println("Task must be single word, start with letter ");
											System.out.println("Alphanumeric with no special character");
									...
									{
										System.out.println("Task already exits Enter another task");
										taskName=sc2.nextLine();	
									}
								}
								...
								System.out.println("Enter the tags of the task... comma seperated[ex: morning,walk,etc...  ]");
								...
								System.out.println("Enter the data like [YYY-MM-DD]");
								taskTags=sc2.nextLine();
								...
								outer:while(b)
								{
									System.out.println("Enter prioity of the task");
									...
									if(TaskUtil.validateIntInput(input3))
									{
										...
										{
											System.out.println("Please enter valid prioity that is 1 or 5 or 10");
											continue outer;
										}
										b=false;
									}
									...
									{
										System.out.println("Please enter valid priority that is 1 or 5 or 10");
										continue outer;
									}
								}
								priority =Integer.parseInt(input3);
							...
							case 2:
								if(category.getTasks().size()!=0)
								{
									...
									System.out.println("]");
									System.out.println("Enter the task to update which are shown in above list");
									taskName=sc2.nextLine();
									...
									if(Model.checkIfTaskExists(category, taskName))
									{
										...
										while(choice3!=6)
										{
											logger.log("----Updated task---");
											System.out.println("PRESS 1 TO UPADATE NAME");
											...
											case 3:
												...
												System.out.println("Enter the new tags of the task...comma seperated[ex:morning,walk,etc...]");
											...
											case 4:
												logger.log("---updating task planned---");
												System.out.println("Enter the new planned date the failed...");
												System.out.println("Enter the date like this[YYYY-MM-DD]");
												date=sc2.nextLine();
												while(!TaskUtil.validateDate(date))
												{
													logger.log("---Updated task new planned date failed----");
													System.out.println("Invalid date");
													System.out.println("enter the date like this[YYYY-MM-DD]");
													date=sc2.nextLine();
												}
												...
												outer:while(b)
												{
													...
													if(TaskUtil.validateIntInput(input4))
													{
														...
														while(!TaskUtil.validatePriority(newPriority))
														{
															...
															System.out.println("Please enter valid priority 1 or 5 or 10");
															continue outer;
														}
														b=false;
													}
													...
													{
														System.out.println("please enter valid priorty like 1 or 5 or 10");
														continue outer;
													}
												}
												newPriority=Integer.parseInt(input4);
							...
							case 3:
								if(category.getTasks().size()!=0)
								{
									...
									System.out.println("Enter task to be removed shown in abive task list");
									taskName=sc2.nextLine();
									if(Model.checkIfTaskExists(category, taskName))
									{
									...
									else
									{
										...
										System.out.println("No tasks exists");
									}
								...
								{
									logger.log("---Task deletion failed---");
									System.out.println("No tasks created yet add new tasks");
								}
								break;
							...
							case 4:
								if(category.getTasks().size()!=0)
								{
									...
									outer:while(b)
									{
										...
										case 2:
											Model.listTaskByDueDate(category);
											break;
											
										case 3:
											Model.listByPrioity(category);
											break;
											
											default:
												System.out.println("Options not supported yet");
												break;
										}
										b=false;
									}
							...
							case 5:
								...
								{
									System.out.println("Element to be searched should not be empty enter something to search: ");
									search=sc2.nextLine();
								}
				...
				case 2:
					...
					logger.log("---updated category---");
					categoryName=sc2.nextLine();
					if(Model.isTheCategoryExist(categoryName))
					{
						Categories categoryToBeLoaded=Model.getCategoty(categoryName);
						choice2=0;
						while(choice2!=6)
						{
							b=true;
							...
							case 2:
										...
										while(choice3!=6)
										{
											...
											case 1:
												...
												outer:while(b)
												{
													...
													{
														logger.log("--- Updating task name failed---");
														System.out.println("Task already existes Enter task name");
														taskName=sc2.nextLine();
													}
												}
												break;
											...
											case 2:
												...
												{
													logger.log("---Updating task description failed---");
													System.out.println("Description should not be empty gove proper description");
													newTaskDescription=sc2.nextLine();
												}
												taskToBeUpdated.setTaskDescription(newTaskDescription);
											...
											case 3:
												logger.log("---Updating task tags---");
												System.out.println("Enter the new tags of task...comma seperated[ex:daily,morining,etc...]");
												newTaskTags=sc2.nextLine();
												while(!TaskUtil.checkIfDescriptionOrTagsAreValid(newTaskTags))
												{
													logger.log("---Updating task tags failed---");
											...
											case 4:
												...
												System.out.println("Enyer the new date the task to be completed");
												System.out.println("Enter the date like this[YYYY-MM-DD]");
												date=sc2.nextLine();
												while(!TaskUtil.validateDate(date))
												{
								...
								{
									logger.log("---Category loading failed---");
									System.out.println("There is no such task present in the category to update");
								}
								break;
							...
							case 3:
								if(categoryToBeLoaded.getTasks().size()!=0)
								{
									...
									System.out.println("]");
									logger.log("---Deleting task---");
									System.out.println("Enter task to be removed shown in task list");
									taskName=sc2.nextLine();
									if(Model.checkIfTaskExists(categoryToBeLoaded, taskName))
									{
									...
									{
										logger.log("---Tasj Deletion failed---");
										System.out.println("Task not exists");
									}
								}
								else
								{
									logger.log("---Task Deletetion failed---");
							...
							case 4:
								if(categoryToBeLoaded.getTasks().size()!=0)
								{
									...
									{
										System.out.println("PRESS 1 TO LIST TASKS BY ALPHABETICAL ORDER OF TASK NAME");
										System.out.println("PRESS 2 TO LIST TASKS BY DUE DATES");
										System.out.println("PRESS 3 TO LIST TASKS BY PRIORITY");
										input5=sc1.nextLine();
										while(!TaskUtil.validateIntInput(input5))
										{
										...
										case 2:
											Model.listTaskByDueDate(categoryToBeLoaded);
											break;
											
										case 3:
											Model.listByPrioity(categoryToBeLoaded);
											break;
								...
								{
									System.out.println("No tasks exits in the category");
								}
								b=true;
							...
							case 5:
								...
								while(search==null|| search.trim().equals(""))
								{
									System.out.println("Elements to be searched should not be empty enter something to search");
					...
					{
						System.out.println("Category doesnot exits");
					}
					break;
				...
				case 3:
					...
					{
						System.out.println("No category exits yet... add new categories");
					}
					break;
				...
				case 4:
					...
					{
						System.out.println("No category exits... add new category");
					}
					break;
				...
				case 5:
					...
					{
						logger.log("----Category Delettion falied---");
